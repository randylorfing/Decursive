...
choice("muf.order", "GROUP", {
    "GROUP", "PRIORITY", "DANDERSFRAMES",
}, "MUFS", "FRAME", "MUF order")
number("muf.partySize", 30, 10, 80, 1, "px", "MUFS", "SIZE", "Party MUF size")
number("muf.raidSize", 30, 10, 80, 1, "px", "MUFS", "SIZE", "Raid MUF size")
number("muf.horizontalSpacing", 2, 0, 100, 1, "px", "MUFS", "LAYOUT", "Horizontal spacing")
number("muf.verticalSpacing", 2, 0, 100, 1, "px", "MUFS", "LAYOUT", "Vertical spacing")
