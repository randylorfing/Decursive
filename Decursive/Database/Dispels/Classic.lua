...
D:RegisterDispelDBExpansion("Classic", { order=1, retail=true, coverage="module-ready", notes="Per-expansion module is active; encounter debuff harvesting is ongoing." }, {
})
