...
L["CURE_BINDING_CARD"] = "Automatic Cure Bindings"
L["CURE_BINDING_DESC"] = "Simple Two-Button keeps targeted friendly cures first: Left, Right, then Ctrl+Left. Middle targets and Ctrl+Middle focuses. Secure changes apply only outside combat."
L["CURE_BINDING_MODE"] = "Binding mode"
L["CURE_BINDING_AUTO"] = "Simple Two-Button"
L["CURE_BINDING_MANUAL"] = "Manual Cure Bindings"
L["CURE_BINDING_RESTORE_AUTO"] = "Restore Simple Two-Button"
L["CURE_BINDING_AUTO_RESTORED"] = "Automatic cure bindings restored for this environment."
L["CURE_BINDING_COMBAT"] = "Cure bindings are locked during combat; the current secure layout remains active."
L["CURE_BINDING_DUPLICATE"] = "That gesture is already assigned to another available action."
L["CURE_BINDING_RESERVED"] = "That gesture is reserved for targeting, focusing, or the active PvP bandage action."
L["CURE_BINDING_UNASSIGNED"] = "Unassigned"
L["CURE_BINDING_AREA"] = "Area utility"
L["CURE_BINDING_PVP_BANDAGE"] = "PvP bandage"
L["CURE_BINDING_UNAVAILABLE"] = "Unavailable in this specialization"
L["CURE_BINDING_TARGETED"] = "Targeted cure"
L["CURE_BINDING_ADDITIONAL"] = "Additional action"
L["CURE_BINDING_SLOT"] = "Slot %d"
L["CURE_BINDING_EMPTY_SLOT"] = "No action in slot %d"
L["CURE_BINDING_FIXED_ACTIONS"] = "Middle: target  ·  Ctrl+Middle: focus"
L["CURE_BINDING_BUTTON5"] = "Button5: %s"
L["CURE_BINDING_BUTTON5_DETAIL"] = "Button5: %s · %s"
L["CURE_BINDING_NO_BANDAGE"] = "Button5: no verified PvP bandage available"
L["CURE_BINDING_BANDAGE_HELP"] = "Button5 scans carried bags only. A built-in item must publicly expose the Mending Bandage use spell, have a public positive count, and be usable. Highest public item level wins; when level is unavailable, the lowest item ID and earliest bag/slot provide an honest deterministic fallback. Bank, reagent-bank, and account-bank items are ignored."
L["CURE_BINDING_BANDAGE_SOURCE_BUILTIN"] = "bag"
L["CURE_BINDING_BANDAGE_SOURCE_EXTERNAL"] = "resolver"
L["CURE_BINDING_BANDAGE_LEVEL"] = "%s iLvl %d"
L["CURE_BINDING_BANDAGE_FALLBACK"] = "%s fallback"

L["MUF_PRIORITY_COLORS_CARD"] = "Affliction Priority Colors"
L["MUF_PRIORITY_COLORS_HELP"] = "The highest visible cure priority fills the MUF center. A simultaneous lower priority appears as a managed border. Colors follow cure action priority, not its mouse gesture."
L["MUF_PRIORITY_COLORS_EMPTY"] = "No assigned targeted cure currently owns a native affliction-color slot."
L["MUF_PRIORITY_COLOR_ROW"] = "Priority %d — %s"
L["MUF_PRIORITY_COLOR_ROW_DESC"] = "%s · Removes %s"
L["MUF_PRIORITY_COLOR_TYPES_UNKNOWN"] = "configured afflictions"
L["MUF_PRIORITY_COLORS_UTILITIES"] = "Target, focus, resurrection, bandage, area, self-only, enemy, and custom utility bindings do not paint affliction colors."
L["MUF_PRIORITY_COLORS_RESET"] = "Restore Default Colors"
L["MUF_PRIORITY_COLORS_UPDATED"] = "Affliction priority color updated."
L["MUF_PRIORITY_COLORS_DEFERRED"] = "Color saved; protected MUF visuals will refresh when restrictions end."
L["MUF_PRIORITY_COLORS_COMBAT"] = "Affliction priority colors are locked during combat."
L["MUF_PRIORITY_COLORS_RESET_DONE"] = "Default affliction priority colors restored."
L["MUF_PRIORITY_COLORS_RESET_DEFERRED"] = "Default colors restored; protected MUF visuals will refresh when restrictions end."

L["PROFILE_ACCOUNT_DEFAULT"] = "Account-wide default Decursive Profile"
L["PROFILE_ACTIVATION_MODE"] = "Activation mode"
L["PROFILE_AUTOMATIC_BEHAVIOR"] = "Five complete Environment Profiles"
L["PROFILE_AUTOMATIC_BEHAVIOR_DESC"] = "Every setting is independent in Open World, Party/Dungeon, Mythic+, Raid and PvP. Automatic precedence is PvP > Raid > Mythic+ > Party/Dungeon > Open World."
L["PROFILE_CHARACTER_ASSIGNMENT"] = "This character"
L["PROFILE_COPY_CURRENT"] = "Copy Current"
L["PROFILE_CREATE_SWITCH"] = "Create / Switch"
L["PROFILE_CURRENT"] = "Current profile"
L["PROFILE_CURRENT_SPEC"] = "Current specialization"
L["PROFILE_CURRENTLY_ACTIVE"] = "Currently active"
L["PROFILE_DECURSIVE_PAGE"] = "Decursive Profiles"
L["PROFILE_DECURSIVE_PAGE_DESC"] = "Create, switch, protect, and transfer complete Decursive setups."
...
L["PROFILE_EDIT_ENVIRONMENT"] = "Edit Selected Environment Profile"
L["PROFILE_ENVIRONMENT_PAGE"] = "Environment Profiles"
L["PROFILE_ENVIRONMENT_PAGE_DESC"] = "A Decursive Profile contains five complete Environment Profiles. Select one and choose Edit to open all of its settings."
L["PROFILE_FUTURE_SCHEMA"] = "Newer profile data detected. Profile changes are read-only."
L["PROFILE_SCHEMA_INCOMPATIBLE"] = "This Decursive build supports profile schema %d, but SavedVariables use newer schema %d. Decursive is disabled and the SavedVariables were not changed. Install a compatible newer build or restore a backup before trying again."
L["PROFILE_SCHEMA_RESET_NOTICE"] = "Decursive's saved settings were reset for profile schema 6. Previous profiles, assignments, cure order, custom actions, bindings, MUF layout, colors, alerts, and other Decursive settings were intentionally removed. Please reconfigure Decursive before entering combat."
L["PROFILE_EXPORT_CARD"] = "Export complete Decursive Profile"
L["PROFILE_EXPORT_CARD_DESC"] = "Generate one portable string containing all five complete Environment Profiles."
L["PROFILE_EXPORT_GENERATE"] = "Generate & Select"
L["PROFILE_EXPORT_STRING"] = "Profile string"
L["PROFILE_IMPORT_BUTTON"] = "Import All Five Environment Profiles"
L["PROFILE_IMPORT_CARD"] = "Import complete Decursive Profile"
L["PROFILE_IMPORT_CARD_DESC"] = "Import transactionally replaces all five Environment Profiles, including class and specialization cure order and custom actions. Account assignments, locale, diagnostics, and caches are not overwritten."
L["PROFILE_IMPORT_STRING"] = "Paste a Decursive profile string"
L["PROFILE_NAME"] = "Profile name"
L["PROFILE_NAME_EXAMPLE"] = "Example: Mythic Healer"
L["PROFILE_NAMED_CARD"] = "Decursive Profile"
L["PROFILE_NAMED_CARD_DESC"] = "Switching profiles changes the complete Decursive setup."
L["PROFILE_RESET_CURRENT"] = "Reset Current Profile"
L["PROFILE_RESET_ENVIRONMENT"] = "Reset Selected to Defaults"
L["PROFILE_COPY_ENVIRONMENT"] = "Copy Into Selected"
L["PROFILE_COPY_ENVIRONMENT_SOURCE"] = "Copy settings from"
L["PROFILE_RUNTIME_ASSIGNMENTS"] = "Runtime assignments"
L["PROFILE_RUNTIME_ASSIGNMENTS_DESC"] = "Choose account-wide, character, and specialization selection metadata. These assignments select a Decursive Profile; gameplay settings remain inside its five Environment Profiles."
...
L["PROFILE_SPEC_ASSIGNMENT_STATE"] = "Specialization assignment state"
L["PROFILE_SPEC_USES_FALLBACK"] = "Active: character/account fallback"
L["PROFILE_SPEC_DISABLED"] = "Disabled"
L["PROFILE_USE_ACCOUNT_DEFAULT"] = "Use account default"
L["PROFILE_USE_CHARACTER_ASSIGNMENT"] = "Use character assignment"
L["PROFILE_WORKSPACE_DESC"] = "Manage saved setups separately from the rules that select them."
L["PROFILE_WORKSPACE_TITLE"] = "Profiles without guesswork"
