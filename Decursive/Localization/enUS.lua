...
L["PROFILE_AUTOMATIC_BEHAVIOR"] = "Full environment variants"
...
L["PROFILE_EDIT_ENVIRONMENT"] = "Edit and preview complete variant"
L["PROFILE_ENVIRONMENT_PAGE"] = "Environment Profiles"
L["PROFILE_ENVIRONMENT_PAGE_DESC"] = "Assignments choose the logical profile. Environment activation chooses its runtime variant. Editing previews one complete variant across every settings page."
L["PROFILE_FUTURE_SCHEMA"] = "Newer profile data detected. Profile changes are read-only."
L["PROFILE_EXPORT_CARD"] = "Export complete logical profile"
L["PROFILE_EXPORT_CARD_DESC"] = "Generate one portable string containing all five full environment variants."
L["PROFILE_EXPORT_GENERATE"] = "Generate & Select"
L["PROFILE_EXPORT_STRING"] = "Profile string"
L["PROFILE_IMPORT_BUTTON"] = "Import All Five Variants"
L["PROFILE_IMPORT_CARD"] = "Import complete logical profile"
L["PROFILE_IMPORT_CARD_DESC"] = "Import transactionally replaces all five variants of the active logical profile. Global, locale and class-scoped data are not overwritten."
...
L["PROFILE_NAMED_CARD"] = "Named profile"
...
L["PROFILE_RESET_ENVIRONMENT"] = "Reset Edited to Preset"
L["PROFILE_COPY_ENVIRONMENT"] = "Copy Into Edited Variant"
