...
-- ============================================================================
-- Midnight / secret-value hygiene (DandersFrames-aligned)
-- ============================================================================
...
function D:FormatNumberSafe(value, fmt, fallback)
    ...
    return string.format(fmt or "%.0f", value)
end

function D:IsSecretValue(value)
...
D.Compat121 = {
    ...
    SetTextureColorSafe = function(_, texture, r, g, b, a, secretBool, trueColor, falseColor)
        return D:SetTextureColorSafe(texture, r, g, b, a, secretBool, trueColor, falseColor)
    end,
    FormatNumberSafe = function(_, value, fmt, fallback)
        return D:FormatNumberSafe(value, fmt, fallback)
    end,
