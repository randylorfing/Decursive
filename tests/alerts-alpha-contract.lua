...
Check(mufs:find("ShouldBeginSoulLinkAttempt(self.unit)", 1, true), "secure MUF pre-click gates Soul Link attribution")
Check(mufs:find("IsPubliclyDeadUnit(unit) and SoulLinkFallbackApplies(unit)", 1, true), "living dispel cannot arm battle-rez warning")
