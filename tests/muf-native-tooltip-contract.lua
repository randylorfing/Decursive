...
Equal(assert(FindCall(container.slot, "EnableMouse"))[2], false, "native slot never broadly re-enables mouse clicks")
Equal(assert(FindCall(container.slot, "SetMouseMotionEnabled"))[2], true, "native slot receives mouse motion")
